...
Original file is located at
    https://colab.research.google.com/drive/1kMDvXtuSfvHmV0YtJ0a2ZeBBfkN1Af4g
"""
...
my_devices.extend([
    ...
    {'DeviceName': "Rene's Apple Watch", 'Status': True, 'IP_Address': '192.323.545.68', 'Model': 'Series 10"', 'Color': 'Matte Black'},
    {'DeviceName': "Rene's Apple TV", 'Status': False, 'IP_Address': '192.543.469.57', 'Model': 'Apple TV 4K (3rd Generation) Wi-Fi + Ethernet"', 'Color': 'Black'},
])
